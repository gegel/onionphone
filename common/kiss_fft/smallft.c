		   ...
		   float *wa2, float *wa3)
{
	...
	float ci2, ci3, ci4, cr2, cr3, cr4, ti1, ti2, ti3, ti4, tr1, tr2, tr3,
	    tr4;
	t0 = l1 * ido;
...
static void drftf1(int n, float *c, float *ch, float *wa, int *ifac)
{
	...
	for (k1 = 0; k1 < nf; k1++) {
		...
		ix3 = ix2 + ido;
		if (na != 0)
			dradf4(ido, l1, ch, c, wa + iw - 1, wa + ix2 - 1,
			       wa + ix3 - 1);
		else
			dradf4(ido, l1, c, ch, wa + iw - 1, wa + ix2 - 1,
			       wa + ix3 - 1);
		goto L110;
		   ...
		   float *wa2, float *wa3)
{
	...
	for (k = 0; k < l1; k++) {
		...
		for (i = 2; i < ido; i += 2) {
			...
			ch[(t8 += t0) - 1] =
			    wa2[i - 2] * cr3 - wa2[i - 1] * ci3;
			ch[t8] = wa2[i - 2] * ci3 + wa2[i - 1] * cr3;
			ch[(t8 += t0) - 1] =
			    wa3[i - 2] * cr4 - wa3[i - 1] * ci4;
...
{
	static float tpi = 6.283185307179586f;
	int idij, ipph, i, j, k, l, ik, is, t0, t1, t2, t3, t4, t5, t6, t7, t8,
	    t9, t10, t11, t12;
	float dc2, ai1, ai2, ar1, ar2, ds2;
	int nbd;
	float dcp, arg, dsp, ar1h, ar2h;
...
static void drftb1(int n, float *c, float *ch, float *wa, int *ifac)
{
	...
	for (k1 = 0; k1 < nf; k1++) {
		...
		if (na != 0)
			dradb4(ido, l1, ch, c, wa + iw - 1, wa + ix2 - 1,
			       wa + ix3 - 1);
		else
			dradb4(ido, l1, c, ch, wa + iw - 1, wa + ix2 - 1,
			       wa + ix3 - 1);
		na = 1 - na;
		goto L115;
