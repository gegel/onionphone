...
void w_D_plsf_5 (
    Word16 *indice,    /* input : quantization indices of 5 w_submatrices     */
...
void w_Int_lpc (
    Word16 w_lsp_old[],  /* input: LSP vector at the 4th w_subfr. of past frame */
...
void w_Pred_lt_6 (
    Word16 w_exc[],      /* in/out: w_excitation buffer                         */
...
void w_Bits2w_prm_12k2 (
    Word16 bits[],     /* input : w_serial bits                               */
    Word16 w_prm[]       /* output: analysis parameters                       */
);
void w_Prm2bits_12k2 (
    Word16 w_prm[],      /* input : analysis parameters                       */
