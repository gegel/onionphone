...
*/
		...
		par->bpvc_index =
		    mf_vsetbits(par->bpvc_index, 3, 4, &mf_codewd84[4]);
/*
...
*/
		...
		par->fsvq_index[0] =
		    mf_vsetbits(par->fsvq_index[0], 7, 3, &mf_codewd74[4]);
/*
...
*/
		...
		mf_sbc_enc(mf_codewd74, 7, 4, &mf_pmat74[0][0]);
		par->fsvq_index[0] =
		    mf_vsetbits(par->fsvq_index[0], 4, 3, &mf_codewd74[4]);
/*
...
*/
		...
		mf_sbc_enc(mf_codewd74, 7, 4, &mf_pmat74[0][0]);
		par->fsvq_index[0] =
		    mf_vsetbits(par->fsvq_index[0], 1, 2, &mf_codewd74[4]);
		par->jit_index =
		    mf_vsetbits(par->jit_index, 0, 1, &mf_codewd74[6]);
	}
...
*/
		...
		berr_pos =
		    mf_sbc_dec(mf_codewd84, 8, 4, &mf_pmat84[0][0],
			       mf_syntab84);
		erase |= berr_pos == BEP_UNCORR;
		par->msvq_index[0] =
		    mf_vsetbits(par->msvq_index[0], 6, 4, mf_codewd84);
		par->bpvc_index = 0;
...
*/
			...
			mf_sbc_dec(mf_codewd74, 7, 4, &mf_pmat74[0][0],
				   mf_syntab74);
			par->msvq_index[0] =
			    mf_vsetbits(par->msvq_index[0], 2, 3, mf_codewd74);
/*
...
*/
			...
			mf_sbc_dec(mf_codewd74, 7, 4, &mf_pmat74[0][0],
				   mf_syntab74);
			par->gain_index[1] =
			    mf_vsetbits(par->gain_index[1], 4, 4, mf_codewd74);
/*
...
*/
			...
			mf_sbc_dec(mf_codewd74, 7, 4, &mf_pmat74[0][0],
				   mf_syntab74);
			par->gain_index[1] =
			    mf_vsetbits(par->gain_index[1], 0, 1, mf_codewd74);
			par->gain_index[0] =
			    mf_vsetbits(par->gain_index[0], 2, 3,
					&mf_codewd74[1]);
			par->jit_index = 1;
		}
	}
