 ...
 */
extern int16_t gsm_mult(int16_t a, int16_t b);
extern int32_t gsm_L_mult(int16_t a, int16_t b);
extern int16_t gsm_mult_r(int16_t a, int16_t b);

extern int16_t gsm_div(int16_t num, int16_t denum);

extern int16_t gsm_add(int16_t a, int16_t b);
extern int32_t gsm_L_add(int32_t a, int32_t b);

extern int16_t gsm_sub(int16_t a, int16_t b);
extern int32_t gsm_L_sub(int32_t a, int32_t b);

extern int16_t gsm_norm(int32_t a);

extern int32_t gsm_L_asl(int32_t a, int n);
extern int16_t gsm_asl(int16_t a, int n);

extern int32_t gsm_L_asr(int32_t a, int n);
extern int16_t gsm_asr(int16_t a, int n);
 ...
 */
extern void Gsm_Coder(struct gsm_state * S, int16_t * s,	/* [0..159] samples             IN      */
...
extern void Gsm_LPC_Analysis(struct gsm_state * S, int16_t * s,	/* 0..159 signals      IN/OUT  */
				int16_t * LARc);	/* 0..7   LARc's       OUT     */

extern void Gsm_Preprocess(struct gsm_state * S, int16_t * s, int16_t * so);

extern void Gsm_Encoding(struct gsm_state * S,
			    int16_t * e,
			    int16_t * ep, int16_t * xmaxc, int16_t * Mc, int16_t * xMc);

extern void Gsm_Short_Term_Analysis_Filter(struct gsm_state * S, int16_t * LARc,	/* coded log area ratio [0..7]  IN      */
					      int16_t *
					      d
					      /* st res. signal [0..159]      IN/OUT  */
					      );

extern void Gsm_Decoder(struct gsm_state * S, int16_t * LARcr,	/* [0..7]               IN      */
			   int16_t * Ncr,	/* [0..3]               IN      */
			   int16_t * bcr,	/* [0..3]               IN      */
			   int16_t * Mcr,	/* [0..3]               IN      */
...
extern void Gsm_Decoding(struct gsm_state * S, int16_t xmaxcr, int16_t Mcr, int16_t * xMcr,	/* [0..12]              IN      */
			    int16_t * erp);	/* [0..39]              OUT     */

extern void Gsm_Long_Term_Synthesis_Filtering(struct gsm_state * S, int16_t Ncr, int16_t bcr, int16_t * erp,	/* [0..39]                IN    */
						 int16_t * drp);	/* [-120..-1] IN, [0..40] OUT   */

extern void Gsm_Short_Term_Synthesis_Filter(struct gsm_state * S, int16_t * LARcr,	/* log area ratios [0..7]  IN   */
					       int16_t * drp,	/* received d [0...39]     IN   */
					       int16_t * s);	/* signal   s [0..159]    OUT   */

extern void Gsm_Update_of_reconstructed_short_time_residual_signal(int16_t * dpp,	/* [0...39]     IN      */
								      int16_t * ep,	/* [0...39]     IN      */
								      int16_t * dp);	/* [-120...-1]  IN/OUT  */

extern void Gsm_RPE_Encoding(struct gsm_state * S, int16_t * e,	/* -5..-1][0..39][40..44        IN/OUT  */
				int16_t * xmaxc,	/*                              OUT */
				int16_t * Mc,	/*                              OUT */
				int16_t * xMc);	/* [0..12]                      OUT */

extern void Gsm_RPE_Decoding(struct gsm_state * S, int16_t xmaxcr, int16_t Mcr, int16_t * xMcr,	/* [0..12], 3 bits             IN      */
				int16_t * erp);	/* [0..39]                     OUT     */
