...
/* Subroutine */ int ham84_(int32_t * input, int32_t * output, int32_t * errcnt)
{
	...
	static int32_t dactab[128] =
		...
		5, 21, 6, 5, 8, 11, 11, 27,
		12, 5, 14, 11, 2, 1, 18, 2, 12, 5, 2, 7, 12, 9, 2, 11, 28, 12,
		12, 15, 0, 3, 3, 19, 4, 13,
		6, 3, 8, 13, 10, 3, 13, 29, 14, 13, 4, 1, 10, 3, 20, 4, 4, 7,
		10, 9, 26, 10, 4, 13, 10, 15,
		8, 1, 6, 3, 6, 5, 22, 6, 24, 8, 8, 11, 8, 13, 6, 15, 1, 17, 2,
		1, 4, 1, 6, 15, 8, 1, 10, 15,
		12, 15, 15, 31
	};
