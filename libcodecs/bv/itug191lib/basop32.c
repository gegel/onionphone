...
/*___________________________________________________________________________
 ...
 |        bv_bv_L_macNs(L_var3,var1,var2) = L_bv_add_c(L_var3,L_bv_mult(var1,var2)).     |
 |                                                                           |
 |   Complexity weight : 1                                                   |
 |                                                                           |
 |   Inputs :                                                                |
 ...
 |   Caution :                                                               |
 |                                                                           |
 |    In some cases the bv_Carry flag has to be cleared or set before using     |
...
#if (WMOPS)
	bv_multiCounter[currCounter].L_bv_mult--;
	bv_multiCounter[currCounter].L_bv_add_c--;
	bv_multiCounter[currCounter].bv_bv_L_macNs++;
#endif
	return (L_var_out);
}
...
/*___________________________________________________________________________
 ...
 |        bv_bv_L_msuNs(L_var3,var1,var2) = L_bv_sub_c(L_var3,L_bv_mult(var1,var2)).     |
 |                                                                           |
 |   Complexity weight : 1                                                   |
 |                                                                           |
 |   Inputs :                                                                |
...
#if (WMOPS)
	bv_multiCounter[currCounter].L_bv_mult--;
	bv_multiCounter[currCounter].L_bv_sub_c--;
	bv_multiCounter[currCounter].bv_bv_L_msuNs++;
...
/*___________________________________________________________________________
 |                                                                           |
 |   Function Name : L_bv_add_c                                                 |
 |                                                                           |
 |   Purpose :                                                               |
 |                                                                           |
 |   Performs 32 bits bv_addition of the two 32 bits variables (L_var1+L_var2+C)|
 |   with carry. No saturation. Generate carry and bv_Overflow values. The car- |
...
/*___________________________________________________________________________
 |                                                                           |
 |   Function Name : L_bv_sub_c                                                 |
 |                                                                           |
 |   Purpose :                                                               |
 |                                                                           |
 |   Performs 32 bits bv_subtraction of the two 32 bits variables with carry    |
 |   (borrow) : L_var1-L_var2-C. No saturation. Generate carry and bv_Overflow  |
...
int32_t L_bv_sub_c(int32_t L_var1, int32_t L_var2)
{
	...
	if (bv_Carry) {
		bv_Carry = 0;
		if (L_var2 != MIN_32) {
			L_var_out = L_bv_add_c(L_var1, -L_var2);
#if (WMOPS)
			bv_multiCounter[currCounter].L_bv_add_c--;
#endif
		} else {
...
/*___________________________________________________________________________
 |                                                                           |
 |   Function Name : bv_bv_shr_r                                                   |
 |                                                                           |
 |   Purpose :                                                               |
 |                                                                           |
 |   Same as bv_shr(var1,var2) but with rounding. Saturate the result in case of|
 |   underflows or overflows :                                               |
 |    - If var2 is greater than zero :                                       |
 |          if (bv_sub(bv_shl(bv_shr(var1,var2),1),bv_shr(var1,bv_sub(var2,1))))            |
 |          is equal to zero                                                 |
 |                     then                                                  |
 |                     bv_bv_shr_r(var1,var2) = bv_shr(var1,var2)                     |
 |                     else                                                  |
 |                     bv_bv_shr_r(var1,var2) = bv_add(bv_shr(var1,var2),1)              |
...
#if (WMOPS)
	bv_multiCounter[currCounter].bv_bv_shr_r++;
#endif
	return (var_out);
}
...
/*___________________________________________________________________________
 ...
 |            bv_mac_r(L_var3,var1,var2) = round(bv_L_mac(L_var3,var1,var2))       |
 |                                                                           |
 |   Complexity weight : 1                                                   |
 |                                                                           |
 |   Inputs :                                                                |
...
int16_t bv_mac_r(int32_t L_var3, int16_t var1, int16_t var2)
{
	...
	bv_multiCounter[currCounter].L_bv_add--;
	bv_multiCounter[currCounter].bv_extract_h--;
	bv_multiCounter[currCounter].bv_mac_r++;
#endif
	return (var_out);
}
...
/*___________________________________________________________________________
 ...
 |            bv_msu_r(L_var3,var1,var2) = round(bv_L_msu(L_var3,var1,var2))       |
 |                                                                           |
 |   Complexity weight : 1                                                   |
 |                                                                           |
 |   Inputs :                                                                |
...
int16_t bv_msu_r(int32_t L_var3, int16_t var1, int16_t var2)
{
	...
	bv_multiCounter[currCounter].L_bv_add--;
	bv_multiCounter[currCounter].bv_extract_h--;
	bv_multiCounter[currCounter].bv_msu_r++;
#endif
	return (var_out);
}
...
/*___________________________________________________________________________
 |                                                                           |
 |   Function Name : bv_L_sat                                                   |
 |                                                                           |
 |   Purpose :                                                               |
 |                                                                           |
 |    32 bit L_var1 is set to 2147483647 if an overflow occured or to        |
 |    -2147483648 if an underflow occured on the most recent L_bv_add_c,        |
 |    L_bv_sub_c, bv_bv_L_macNs or bv_bv_L_msuNs operations. The carry and overflow values  |
...
#if (WMOPS)
	bv_multiCounter[currCounter].bv_L_sat++;
#endif
	return (L_var_out);
}
...
/*___________________________________________________________________________
 |                                                                           |
 |   Function Name : bv_L_mls                                                   |
 |                                                                           |
 |   Purpose :                                                               |
 |                                                                           |
 |   Multiplies a 16 bit word v by a 32 bit word Lv and returns a 32 bit     |
 |   word (bv_multiplying 16 by 32 bit words gives 48 bit word; the function    |
...
int32_t bv_L_mls(int32_t Lv, int16_t v)
{
	...
	bv_multiCounter[currCounter].bv_L_mac--;
	bv_multiCounter[currCounter].bv_extract_h--;
	bv_multiCounter[currCounter].bv_L_mls++;
#endif
...
|   If L_var1 == var2 << 16 then bv_div_l(L_var1,var2) = 32767.                |
|                                                                           |
...
/*__________________________________________________________________________
|                                                                           |
|   Function Name : i_bv_mult                                                  |
|                                                                           |
|   Purpose :                                                               |
|                                                                           |
|   Integer 16-bit bv_multiplication. No overflow protection is performed if   |
