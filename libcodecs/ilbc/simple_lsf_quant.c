    ...
    )
{
	...
	WebRtcIlbcfix_SplitVq(lsfdeq, index, lsf,
			      (WebRtc_Word16 *) WebRtcIlbcfix_kLsfCb,
			      (WebRtc_Word16 *) WebRtcIlbcfix_kLsfDimCb,
			      (WebRtc_Word16 *) WebRtcIlbcfix_kLsfSizeCb);

	if (lpc_n == 2) {
		/* Quantize second LSF with memoryless split VQ */
		WebRtcIlbcfix_SplitVq(lsfdeq + LPC_FILTERORDER,
				      index + LSF_NSPLIT, lsf + LPC_FILTERORDER,
				      (WebRtc_Word16 *) WebRtcIlbcfix_kLsfCb,
				      (WebRtc_Word16 *) WebRtcIlbcfix_kLsfDimCb,
				      (WebRtc_Word16 *)
