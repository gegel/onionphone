...
extern "C" {
   ...
   */
	...
	int16_t WebRtcIlbcfix_EncoderAssign(iLBC_encinst_t **
						  iLBC_encinst,
						  int16_t *
						  ILBCENC_inst_Addr,
						  int16_t * size);
	int16_t WebRtcIlbcfix_DecoderAssign(iLBC_decinst_t **
						  iLBC_decinst,
						  int16_t *
						  ILBCDEC_inst_Addr,
						  int16_t * size);
   ...
   */
	...
	int16_t WebRtcIlbcfix_EncoderCreate(iLBC_encinst_t **
						  iLBC_encinst);
	int16_t WebRtcIlbcfix_DecoderCreate(iLBC_decinst_t **
						  iLBC_decinst);
   ...
   */
	...
	int16_t WebRtcIlbcfix_DecoderInit(iLBC_decinst_t * iLBCdec_inst,
						int16_t frameLen);
	int16_t WebRtcIlbcfix_DecoderInit20Ms(iLBC_decinst_t *
						    iLBCdec_inst);
	int16_t WebRtcIlbcfix_Decoderinit30Ms(iLBC_decinst_t *
						    iLBCdec_inst);
