...
void WebRtcIlbcfix_PackBits(WebRtc_UWord16 * bitstream,	/* (o) The packetized bitstream */
    ...
    )
{
	...
	if (mode == 20) {
		...
		/* 16:th WebRtc_Word16 */
		(*bitstreamPtr) =
		    ((WebRtc_UWord16) ((enc_bits->cb_index[2]) & 0x1)) << 15;
		/* Bit 0  */
		...
		/* 17:th WebRtc_Word16 */
		(*bitstreamPtr) =
		    ((WebRtc_UWord16) ((enc_bits->cb_index[4]) & 0x1)) << 15;
		/* Bit 0  */
		...
		/* 19:th WebRtc_Word16 */
		(*bitstreamPtr) =
		    ((WebRtc_UWord16) ((enc_bits->gain_index[3]) & 0x3)) << 14;
		/* Bit 0..1  */
		...
		/* 19:th WebRtc_Word16 */
		(*bitstreamPtr) =
		    ((WebRtc_UWord16) (enc_bits->cb_index[2]) & 0x7) << 13;
		/* Bit 0..2  */
		...
		/* 20:th WebRtc_Word16 */
		(*bitstreamPtr) =
		    ((WebRtc_UWord16) (enc_bits->cb_index[4]) & 0x7) << 13;
		/* Bit 0..2  */
		...
		/* 21:st WebRtc_Word16 */
		(*bitstreamPtr) =
		    ((WebRtc_UWord16) (enc_bits->cb_index[7]) & 0x7) << 13;
		/* Bit 0..2  */
		...
		/* 22:nd WebRtc_Word16 */
		(*bitstreamPtr) =
		    ((WebRtc_UWord16) (enc_bits->cb_index[10]) & 0xF) << 12;
		/* Bit 0..3  */
		...
		/* 23:rd WebRtc_Word16 */
		(*bitstreamPtr) =
		    ((WebRtc_UWord16) (enc_bits->cb_index[13]) & 0x1F) << 11;
		/* Bit 0..4  */
		...
		/* 24:rd WebRtc_Word16 */
		(*bitstreamPtr) =
		    ((WebRtc_UWord16) (enc_bits->gain_index[5])) << 13;
		/* Bit 0..2  */
		...
		/* 25:rd WebRtc_Word16 */
		(*bitstreamPtr) =
		    ((WebRtc_UWord16) (enc_bits->gain_index[10]) & 0x3) << 14;
		/* Bit 0..1  */
