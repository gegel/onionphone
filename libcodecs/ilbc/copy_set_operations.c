...
void WebRtcSpl_MemSetW16(WebRtc_Word16 * ptr, WebRtc_Word16 set_value,
			 int length)
{
	int j;
...
void WebRtcSpl_MemSetW32(WebRtc_Word32 * ptr, WebRtc_Word32 set_value,
			 int length)
{
	int j;
...
void WebRtcSpl_MemCpyReversedOrder(WebRtc_Word16 * dest, WebRtc_Word16 * source,
				   int length)
{
	int j;
				       ...
				       WebRtc_Word16 * vector_out)
{
	...
	WEBRTC_SPL_MEMCPY_W16(vector_out, &vector_in[length - samples],
			      samples);
