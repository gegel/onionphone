...
void WebRtcIlbcfix_Interpolate(int16_t * out,	/* (o) output vector */
...
{				/* (i) number of sample is vectors */
	...
	for (i = 0; i < length; i++) {
		out[i] = (int16_t) WEBRTC_SPL_RSHIFT_W32((WEBRTC_SPL_MUL_16_16(coef, in1[i]) + WEBRTC_SPL_MUL_16_16(invcoef, in2[i])) + 8192, 14);
	}
