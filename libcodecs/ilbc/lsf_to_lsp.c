...
void WebRtcIlbcfix_Lsf2Lsp(WebRtc_Word16 * lsf,	/* (i) lsf in Q13 values between 0 and pi */
    ...
    )
{
	...
	for (i = 0; i < m; i++) {
		freq =
		    (WebRtc_Word16) WEBRTC_SPL_MUL_16_16_RSFT(lsf[i], 20861,
							      15);
		...
		lsp[i] =
		    WebRtcIlbcfix_kCos[k] +
		    (WebRtc_Word16) (WEBRTC_SPL_RSHIFT_W32(tmpW32, 12));
	}
