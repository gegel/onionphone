    ...
    )
{
	...
	WEBRTC_SPL_MEMCPY_W16(iLBCdec_inst->lsfdeqold, WebRtcIlbcfix_kLsfMean,
			      LPC_FILTERORDER);
	...
	WebRtcSpl_MemSetW16(iLBCdec_inst->old_syntdenum, 0,
			    ((LPC_FILTERORDER + 1) * NSUB_MAX));
	...
	WebRtcSpl_MemSetW16(iLBCdec_inst->enh_buf, 0,
