...
// Get SPL Version
	int16_t WebRtcSpl_get_version(char *version,
					    int16_t length_in_bytes);

	int WebRtcSpl_GetScalingSquare(int16_t * in_vector,
				       int in_vector_length, int times);
...
// Descriptions at bottom of file.
	...
	void WebRtcSpl_MemSetW32(int32_t * vector,
				 int32_t set_value, int vector_length);
	void WebRtcSpl_MemCpyReversedOrder(int16_t * out_vector,
					   int16_t * in_vector,
					   int vector_length);
	int16_t WebRtcSpl_CopyFromEndW16(const int16_t *
					       in_vector,
...
// Signal processing operations. Descriptions at bottom of this file.
	...
	void WebRtcSpl_ReflCoefToLpc(const int16_t * refl_coef,
				     int use_order, int16_t * lpc_coef);
	void WebRtcSpl_LpcToReflCoef(int16_t * lpc_coef,
				     int use_order, int16_t * refl_coef);
	...
	void WebRtcSpl_GetHanningWindow(int16_t * window,
					int16_t size);
...
// descriptions at bottom of this file.
	uint32_t WebRtcSpl_DivU32U16(uint32_t num,
					   uint16_t den);
	int32_t WebRtcSpl_DivW32W16(int32_t num, int16_t den);
	int16_t WebRtcSpl_DivW32W16ResW16(int32_t num,
						int16_t den);
	int32_t WebRtcSpl_DivResultInQ31(int32_t num,
					       int32_t den);
...
// End: Divisions.
	...
	int32_t WebRtcSpl_Energy(int16_t * vector,
				       int vector_length, int *scale_factor);
...
//      - complex_data  : The complex data buffer.
	...
	void WebRtcSpl_ComplexBitReverse(int16_t * __restrict complex_data,
					 int stages);
...
// state structure for 16 -> 22 resampler
	...
	void WebRtcSpl_ResetResample16khzTo22khz(WebRtcSpl_State16khzTo22khz *
						 state);
...
// state structure for 22 -> 8 resampler
	...
	void WebRtcSpl_ResetResample22khzTo8khz(WebRtcSpl_State22khzTo8khz *
						state);
 ...
 ******************************************************************/
	...
	void WebRtcSpl_Resample48khzTo32khz(const int32_t * In,
					    int32_t * Out,
					    const int32_t K);

	void WebRtcSpl_Resample32khzTo24khz(const int32_t * In,
					    int32_t * Out,
					    const int32_t K);

	void WebRtcSpl_Resample44khzTo32khz(const int32_t * In,
					    int32_t * Out,
					    const int32_t K);
 ...
 ******************************************************************/
	...
	void WebRtcSpl_ResetResample48khzTo16khz(WebRtcSpl_State48khzTo16khz *
						 state);
	...
	void WebRtcSpl_ResetResample16khzTo48khz(WebRtcSpl_State16khzTo48khz *
						 state);
	...
	void WebRtcSpl_ResetResample48khzTo8khz(WebRtcSpl_State48khzTo8khz *
						state);
	...
	void WebRtcSpl_ResetResample8khzTo48khz(WebRtcSpl_State8khzTo48khz *
						state);
