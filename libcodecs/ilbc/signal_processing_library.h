...
// Descriptions at bottom of file.
	void WebRtcSpl_MemSetW16(WebRtc_Word16 * vector,
				 WebRtc_Word16 set_value, int vector_length);
	void WebRtcSpl_MemSetW32(WebRtc_Word32 * vector,
				 WebRtc_Word32 set_value, int vector_length);
	void WebRtcSpl_MemCpyReversedOrder(WebRtc_Word16 * out_vector,
					   WebRtc_Word16 * in_vector,
					   int vector_length);
	WebRtc_Word16 WebRtcSpl_CopyFromEndW16(G_CONST WebRtc_Word16 *
					       in_vector,
...
// Signal processing operations. Descriptions at bottom of this file.
	...
	void WebRtcSpl_ReflCoefToLpc(G_CONST WebRtc_Word16 * refl_coef,
				     int use_order, WebRtc_Word16 * lpc_coef);
	void WebRtcSpl_LpcToReflCoef(WebRtc_Word16 * lpc_coef,
				     int use_order, WebRtc_Word16 * refl_coef);
	...
	void WebRtcSpl_GetHanningWindow(WebRtc_Word16 * window,
					WebRtc_Word16 size);
...
// descriptions at bottom of this file.
	WebRtc_UWord32 WebRtcSpl_DivU32U16(WebRtc_UWord32 num,
					   WebRtc_UWord16 den);
	WebRtc_Word32 WebRtcSpl_DivW32W16(WebRtc_Word32 num, WebRtc_Word16 den);
	WebRtc_Word16 WebRtcSpl_DivW32W16ResW16(WebRtc_Word32 num,
						WebRtc_Word16 den);
	WebRtc_Word32 WebRtcSpl_DivResultInQ31(WebRtc_Word32 num,
					       WebRtc_Word32 den);
	WebRtc_Word32 WebRtcSpl_DivW32HiLow(WebRtc_Word32 num,
					    WebRtc_Word16 den_hi,
...
// state structure for 22 -> 8 resampler
	...
	void WebRtcSpl_Resample22khzTo8khz(const WebRtc_Word16 * in,
					   WebRtc_Word16 * out,
...
// state structure for 8 -> 22 resampler
	...
	void WebRtcSpl_Resample8khzTo22khz(const WebRtc_Word16 * in,
					   WebRtc_Word16 * out,
 ...
 ******************************************************************/
	...
	void WebRtcSpl_Resample48khzTo32khz(const WebRtc_Word32 * In,
					    WebRtc_Word32 * Out,
					    const WebRtc_Word32 K);

	void WebRtcSpl_Resample32khzTo24khz(const WebRtc_Word32 * In,
					    WebRtc_Word32 * Out,
					    const WebRtc_Word32 K);

	void WebRtcSpl_Resample44khzTo32khz(const WebRtc_Word32 * In,
					    WebRtc_Word32 * Out,
					    const WebRtc_Word32 K);
 ...
 ******************************************************************/
	...
	void WebRtcSpl_Resample48khzTo16khz(const WebRtc_Word16 * in,
					    WebRtc_Word16 * out,
	...
	void WebRtcSpl_Resample16khzTo48khz(const WebRtc_Word16 * in,
					    WebRtc_Word16 * out,
	...
	void WebRtcSpl_Resample48khzTo8khz(const WebRtc_Word16 * in,
					   WebRtc_Word16 * out,
	...
	void WebRtcSpl_Resample8khzTo48khz(const WebRtc_Word16 * in,
					   WebRtc_Word16 * out,
