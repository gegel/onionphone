...
void WebRtcIlbcfix_CbUpdateBestIndex(WebRtc_Word32 CritNew,	/* (i) New Potentially best Criteria */
...
{				/* (i/o) Gain in Q14 that corresponds
				   to maximum criteria */
	...
	if (WEBRTC_SPL_RSHIFT_W32(CritNew, shNew) >
		...
		gainW32 = WEBRTC_SPL_MUL_16_16_RSFT(((WebRtc_Word16)
						     WEBRTC_SPL_SHIFT_W32
						     (cDotNew, -tmp16)),
						    invEnergyNew, scaleTmp);
