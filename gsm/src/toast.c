...
/* $Header: /cvsroot/speak-freely-u/speak_freely/gsm/src/toast.c,v 1.1.1.1 2002/11/09 12:41:02 johnwalker Exp $ */
	...
	if (st->st_nlink > 1 && !f_cat && !f_precious) {
		fprintf(stderr, 
                      "%s: \"%s\" has %d other link%s -- unchanged.\n",
                        progname, name, st->st_nlink - 1, (st->st_nlink<=2) ? "" : "s");
		return 0;
	}
...
static void version P0()
{
		...
		progname,
                "$Id: toast.c,v 1.1.1.1 2002/11/09 12:41:02 johnwalker Exp $" );
}
