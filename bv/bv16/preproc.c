                ...
                Word16 N)                       /* length of signal                       */
{
   ...
   for(n=0; n<N; n++)
   {
      ...
      a0 = L_bv_add(a0, Mpy_32_16(cs->hpfpm[2], cs->hpfpm[3], hpfa[2]));   // Q14

      /* zero section of filtering */
      a0 = bv_L_mac0(a0, input[n], hpfb[0]);                               // Q14
      a0 = bv_L_mac0(a0, cs->hpfzm[0], hpfb[1]);                           // Q14
      a0 = bv_L_mac0(a0, cs->hpfzm[1], hpfb[2]);                           // Q14
      a0 = L_bv_shl(a0, 1);                                                // Q15
