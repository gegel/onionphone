...
void mf_bpvc_ana(float mf_speech[], float mf_fpitch[], float bpvc[], float sub_pitch[]);
...
void mf_mf_q_gain_dec(float *gain,int *gain_index,float qlow,float qup,float qlev);
...
void mf_scale_adj(float *mf_speech, float gain, float *mf_premf_v_scale, int length, int sc_over);
